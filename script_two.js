...
let p_one=document.querySelectorAll('p')[0];
let b=document.querySelectorAll('h5')[0];
...
input2.addEventListener('click',()=>{   
            ...
            <input type='text' name='textbox' placeholder='Enter direction' style='width:50%;margin-left:20px;'>
            <br>
            <label for="customRange1" style='padding-right:10px;'>Degree range</label>
            <input type="range"  id="customRange1" max=360 min=-360 style='margin-top:5px;'>
            <button type="button">Submit</button>
            <br>
            <br>
            <input type='color' name='colour1' class='edit3' disabled>
            <input type='color' name='colour2' class='edit3' disabled>
            <input type='color' name='colour3' class='edit3' disabled>
            </form>`
            b.innerHTML='Note:After Entering a specific direction or an angle, click on any palette and drag the circular pointer.<br>You can enter the degrees manually or use degree range';
            var textbox_1=document.getElementsByTagName('input')[2];
            var range1=document.querySelectorAll('input')[3];
            var colour1=document.querySelectorAll('input')[4];
            var colour2=document.querySelectorAll('input')[5];
